...
describe('HW1 contract / exports', () => {
  ...
  it('createGame returns an object with the required methods', async () => {
    ...
    expect(typeof game.getCandidateHint).toBe('function')
    expect(typeof game.applyNextStepHint).toBe('function')
    expect(typeof game.isExploring).toBe('function')
    expect(typeof game.startExplore).toBe('function')
    expect(typeof game.exitExplore).toBe('function')
    expect(typeof game.returnToExploreStart).toBe('function')
    expect(typeof game.getExploreStatus).toBe('function')
    expect(typeof game.getExploreCandidateHint).toBe('function')
    expect(typeof game.consumeExploreNotice).toBe('function')
